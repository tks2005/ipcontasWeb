package br.com.ipcontas.security;

import static br.com.ipcontas.utils.JdbcUtils.*;
...
@Component
public class IpcontasUserDetailsService implements UserDetailsService {

	private static final Logger logger = Logger.getLogger(IpcontasUserDetailsService.class.getSimpleName());
	...
	public UserDetails loadUserByUsername(String login) throws UsernameNotFoundException {
		...
		try {
			...
			IpcontasUserDetails userDetails = buscarUsuario(connection, login);
	...
	public IpcontasUserDetails buscarUsuario(Connection connection, String login) throws SQLException {
		...
		return new IpcontasUserDetails(nome, login, password, ativo);
	}
